...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "MyBook";
    ...
    private static final String COL6 = "departure";//Ignore this
    ...
    public boolean addData(String cid,String name,String cat,String auth) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL2, cid);
        contentValues.put(COL3, name);
        contentValues.put(COL4, cat);
        contentValues.put(COL5, auth);
